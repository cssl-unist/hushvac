...
#define FFMALLOC_PLUS
#define MARK_SWEEP

#define STW_TIME
#define STW_TIME_VAL 3
#define SYS_DIRTY
#define SAFE_MODE
...
#ifdef DEBUG
#define lf_dbg(fmt, args...)    fprintf(stderr, "<%s,%d,%s>: " fmt "\n", \
                __FILE__, __LINE__, __func__, ## args)
#define msg(fmt, args...)    fprintf(stderr, "<%s,%d,%s>: " fmt, \
                __FILE__, __LINE__, __func__, ## args)
#else
#define lf_dbg(fmt, args...)
#endif
